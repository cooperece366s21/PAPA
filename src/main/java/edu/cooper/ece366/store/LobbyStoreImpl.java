        ...
        LOBBY_MAP =
                List.of(
                        new LobbyBuilder()
                                ...
                                .putRestaurant_map("panya-bakery-new-york", 2)
                                .putRestaurant_map("mamoun's-halal-new-york", 2)
                                .putRestaurant_map("smac's-american-new-york", 3)
                                .build(),
                        new LobbyBuilder()
                                .ID("code2")
                                .code("code2")
                                ...
                                .putRestaurant_map("panya-bakery-new-york", 2)
                                .putRestaurant_map("mamoun's-halal-new-york", 2)
                                .putRestaurant_map("smac's-american-new-york", 2)
                                .build())
                        .stream()
